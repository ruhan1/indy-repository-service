        ...
        extends AbstractProxyDataManagerTCK
{
            ...
            throws Exception
    {
        ...
        manager.storeArtifactStore(
                new RemoteRepository( MAVEN_PKG_KEY, "central", "http://repo1.maven.apache.org/maven2/" ), summary,
                false, false, new EventMetadata() );

        manager.storeArtifactStore( new RemoteRepository( MAVEN_PKG_KEY, "repo2", "http://repo1.maven.org/maven2/" ),
    ...
    public void createAndRetrieveEmptyGroup()
            throws Exception
    {
        final Group grp = new Group( MAVEN_PKG_KEY, "test" );
    ...
    private void removeStore( final ArtifactStore... stores )
            throws Exception
    {
            ...
            throws Exception
    {
        ...
        final Group grp = new Group( MAVEN_PKG_KEY, "test", new StoreKey( MAVEN_PKG_KEY, remote, "central" ),
                                     new StoreKey( MAVEN_PKG_KEY, remote, "repo2" ) );
        ...
        assertThat( repos.get( 0 ), equalTo( new StoreKey( MAVEN_PKG_KEY, remote, "central" ) ) );
        assertThat( repos.get( 1 ), equalTo( new StoreKey( MAVEN_PKG_KEY, remote, "repo2" ) ) );
    }
            ...
            throws Exception
    {
        ...
        final Group grp = new Group( MAVEN_PKG_KEY, "test", new StoreKey( MAVEN_PKG_KEY, remote, "repo2" ),
                                     new StoreKey( MAVEN_PKG_KEY, remote, "central" ) );

        store( grp );

        final List<ArtifactStore> repos =
                manager.query().getOrderedConcreteStoresInGroup( MAVEN_PKG_KEY, grp.getName() );
            ...
            throws Exception
    {
        ...
        final List<ArtifactStore> result =
                manager.query().getOrderedConcreteStoresInGroup( MAVEN_PKG_KEY, grp.getName() );
            ...
            throws Exception
    {
        ...
        final Group grp = new Group( MAVEN_PKG_KEY, "test" );
        final Group grp2 = new Group( MAVEN_PKG_KEY, "test2" );
        ...
        result.sort( Comparator.comparing( ArtifactStore::getName ) );
    ...
    @Test
    public void createTwoGroupsAndAffectedByForOneLevel()
            throws Exception
    {
        final StoreDataManager manager = getFixtureProvider().getDataManager();
        final StoreKey central = new StoreKey( MAVEN_PKG_KEY, remote, "central" );
        final StoreKey repo2 = new StoreKey( MAVEN_PKG_KEY, remote, "repo2" );
        Group g1 = new Group( MAVEN_PKG_KEY, "g1", central );
        Group g2 = new Group( MAVEN_PKG_KEY, "g2", repo2 );
    ...
    @Test
    public void createTwoGroupsAndAffectedByForTwoLevel()
            throws Exception
    {
        final StoreDataManager manager = getFixtureProvider().getDataManager();
        final StoreKey central = new StoreKey( MAVEN_PKG_KEY, remote, "central" );
        Group g1 = new Group( MAVEN_PKG_KEY, "g1", central );
        Group g2 = new Group( MAVEN_PKG_KEY, "g2", g1.getKey() );
