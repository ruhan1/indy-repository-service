...
import org.commonjava.indy.service.repository.model.AbstractSerializatinTest;
        ...
        extends AbstractSerializatinTest
{
            ...
            throws Exception
    {
        ...
        final StoreListingDTO<HostedRepository> value = mapper.readValue( json, new TypeReference<>()
        {
        } );
