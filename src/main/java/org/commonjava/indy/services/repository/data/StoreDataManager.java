...
public interface StoreDataManager
{
    ...
    /**
     * Check if store is a readonly hosted repository. Return true only when store is a readonly {@link org.commonjava.indy.services.repository.model.HostedRepository}
     */
