...
public class CassandraStoreUtil
{
    ...
    public static String getSchemaCreateTableStore( String keySpace )
    {
        return "CREATE TABLE IF NOT EXISTS " + keySpace + "." + TABLE_STORE + " (" + "typekey varchar,"
                ...
                + "transientmetadata map<text, text>," + "metadata map<text, text>," + "pathmaskpatterns set<text>,"
                + "createtime varchar," + "disabletimeout int," + "authoritativeindex boolean,"
                + "rescaninprogress boolean," + "extras map<text, text>,"
