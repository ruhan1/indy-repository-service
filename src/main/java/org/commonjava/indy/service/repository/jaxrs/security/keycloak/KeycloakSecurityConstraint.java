...
public class KeycloakSecurityConstraint
{
    ...
    public KeycloakSecurityConstraint( String role, String urlPattern, List<String> methods )
    {
        super();
        this.role = role;
    ...
    public KeycloakSecurityConstraint( String role, String urlPattern, String[] methods )
    {
        super();
        this.role = role;
        this.urlPattern = urlPattern;
